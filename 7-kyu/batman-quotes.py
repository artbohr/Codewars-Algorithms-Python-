class BatmanQuotes(object):
    ...
    def get_quote(quotes, hero):
        n_hero = {"B": "Batman", "R": "Robin", "J": "Joker"}[hero[0]]
        return n_hero + ": " + quotes[int([x for x in hero if x.isdigit()][0])]

'''
Batman & Robin have gotten into quite a pickle this time. The Joker has mixed up
their iconic quotes and also replaced one of the characters in their names,
...
"Holy haberdashery, Batman!", "Let's put a smile on that faaaceee!"], "Rob1n")
