def outed(meet, boss):
    total = sum(v if k!=boss else v*2 for k,v in meet.items())/len(meet)
...
In a team meeting, a terrible, awful person declares to the group that you
 aren't working. You're in trouble. You quickly have to gauge the feeling in
 the room to decide whether or not you should gather your things and leave.
