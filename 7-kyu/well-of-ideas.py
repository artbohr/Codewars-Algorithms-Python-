def well(arr):
    a = [y for x in arr for y in x if type(y)==str and y.lower()=='good']
    if len(a) > 2: return 'I smell a series!'
    return 'Publish!' if a else 'Fail!'

'''
For every good kata idea there seem to be quite a few bad ones!

In this kata you need to check the provided 2 dimensional array (x) for
good ideas 'good' and bad ideas 'bad'. If there are one or two good ideas,
