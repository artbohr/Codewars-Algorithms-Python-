def common_ground(s1,s2):
    ...
    for x in s2.split():
        if x in s1.split() and x not in output:
            output.append(x)
...
The discussion gets heated and you are cannot risk favoring either of them as this
 might damage your political standing with either of the two clans the samurai generals
 belong to. Thus, the only thing left to do is find what the common ground of what they are saying is.
