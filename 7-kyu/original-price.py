...
'''
We need to write some code to return the original price of a product, the return
type must be of type decimal and the number must be rounded to two decimal places.
...
return the original price of that item before applying the sale percentage,
