def change_count(change):
    return '${:.2f}'.format(sum([CHANGE.get(x) for x in change.split()]))
...
***These amounts are already preloaded as floats into the CHANGE dictionary
 for you to use!*** (on codewars)
