...
Calculate the tram's minimum capacity such that the number of people inside the tram
never exceeds this capacity at any time. Note that at each stop all exiting passengers
...
Explaination:
    ...
    At the first stop 3 passengers enter the tram, and the number of passengers
     inside the tram becomes 3.
