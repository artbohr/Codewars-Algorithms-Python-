cypher = str.maketrans("GgDdRrPpLlKkAaEeYyOoUuIi", "AaEeYyOoUuIiGgDdRrPpLlKk")
...
The letters, which are not on the list of substitutes, stays in the encrypted text
 without changes.
Task
